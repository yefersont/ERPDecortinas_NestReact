...
export const getTipoProductos = () => api.get(API_URL + "/obtener");
...
export const createCostoTipoProducto = (data) => api.post("/costotipoproducto", data);
export const createTipoProductoCompleto = (data) => api.post(API_URL + "/crear-completo", data);
